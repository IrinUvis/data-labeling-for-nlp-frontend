...
class ProdGetEmotionTextLabelingReminderStatusUseCaseTest {
    ...
    fun useCase_invoked_returnsSuccessWithIsScheduledFalse() = runTest {
        ...
        val useCase = ProdGetTextsLabelingReminderStatusUseCase(
            workManager = workManagerMock,
        )

        val expectedResult = GetTextsLabelingReminderStatusResult.Success(isScheduled = false)
    ...
    fun useCase_invoked_returnsSuccessWithIsScheduledTrue() = runTest {
        ...
        val expectedResult = GetTextsLabelingReminderStatusResult.Success(isScheduled = true)
