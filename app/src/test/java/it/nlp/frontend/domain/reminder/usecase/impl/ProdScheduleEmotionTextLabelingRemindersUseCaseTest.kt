...
class ProdScheduleEmotionTextLabelingRemindersUseCaseTest {
    ...
    fun useCase_invoked_returnsSuccess() = runTest {
        ...
        val useCase = ProdScheduleTextsLabelingRemindersUseCase(
            workManager = workManagerMock,
        )

        val expectedResult = ScheduleTextsLabelingRemindersResult.Success
