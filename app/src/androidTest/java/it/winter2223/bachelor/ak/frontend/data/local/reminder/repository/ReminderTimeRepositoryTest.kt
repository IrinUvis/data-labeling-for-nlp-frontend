...
class ReminderTimeRepositoryTest {
    ...
    @Test
    fun repository_testFetchPreferencesWhenEmpty() = testCoroutineScope.runTest {
        cleanDataStore()
    ...
    @Test
    fun repository_testStorePreferences() = testCoroutineScope.runTest {
        cleanDataStore()
    ...
    @Test
    fun repository_testClearPreferences() = testCoroutineScope.runTest {
        cleanDataStore()
