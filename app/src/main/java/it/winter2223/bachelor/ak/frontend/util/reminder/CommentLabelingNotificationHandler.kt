package it.winter2223.bachelor.ak.frontend.util.reminder
...
import it.winter2223.bachelor.ak.frontend.ui.MainActivity

object CommentLabelingNotificationHandler {
    private const val REMINDERS_CHANNEL_ID = "comment_labeling_reminders"
    private const val COMMENT_LABELING_REMINDER_NOTIFICATION_ID = 1

    fun createCommentLabelingReminderNotification(context: Context) {
        ...
        with(NotificationManagerCompat.from(context)) {
            notify(COMMENT_LABELING_REMINDER_NOTIFICATION_ID, builder.build())
        }
    }
